...
class Tracker:
    ...
    def update(self, objects_rect):
        ...
        for rect in objects_rect:
            ...
            #If the distance is less than a threshold value (35), then the code concludes that the same object has been detected and the same_object_detected variable is set to True. 
