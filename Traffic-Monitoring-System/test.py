...
area = [(225, 335), (803, 335), (962, 408), (57, 408)] #Co-ordinates of the desired region
...
#print(px)
    ...
    # 4. The pointPolygonTest() function is used to check if the center coordinates of the bounding box are inside the specified area.
    ...
    # The following steps are performed:
    # 1. The polylines() function is used to draw the specified area on the frame. 
    ...
    # 3. The putText() function is used to display the number of vehicles in the area on the frame. 
